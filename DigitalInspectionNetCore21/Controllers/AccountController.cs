...
//			{
//				var userIdCookie = Request.Cookies.Get(CookieConstants.UserIdCookieName);
...
//					Response.Cookies.Append(CookieConstants.UserIdCookieName, userId, CookieConstants.DefaultOptions);
//				}
