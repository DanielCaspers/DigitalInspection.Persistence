...
namespace DigitalInspectionNetCore21.Models.Web
{
	...
	public abstract class TypeSafeEnum: IComparable
	{
		...
		protected TypeSafeEnum(int value, string displayName)
		{
			_value = value;
		...
		public static IEnumerable<T> GetAll<T>() where T : TypeSafeEnum, new()
		{
			var type = typeof(T);
		...
		{
			return Value.CompareTo(((TypeSafeEnum)other).Value);
		}
	}
}
